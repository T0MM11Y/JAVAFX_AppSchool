💻📊 This project is a user-friendly desktop application for school-related tasks. It uses JavaFX for creating modern interfaces and follows the Object-Oriented Programming (OOP) paradigm for better code organization and flexibility. With visual elements and structured code, users can easily navigate and interact with the application for various school functions.
